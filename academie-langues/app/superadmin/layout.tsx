        ...
        <header className={`sticky top-0 z-30 flex h-20 shrink-0 items-center gap-3 border-b px-4 backdrop-blur-xl sm:px-6 ${light ? "bg-white/80 border-black/[0.06]" : "border-white/[0.07] bg-[#05070d]/90"}`}>
          ...
          <div className="relative" ref={notificationsRef}>
            ...
            >
              ...
              {alertCounts.badge > 0 && (
                <span className="superadmin-count-badge absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-1 text-[9px] font-black text-white">
                  {alertCounts.badge}
                </span>
              )}
            </button>
