...
export function TableBtnPreview({ onClick, label = "Aperçu" }: { onClick: () => void; label?: string }) {
  return (
    <button
      type="button"
      onClick={onClick}
...
export function TableBtnModify({ onClick, label = "Modifier" }: { onClick: () => void; label?: string }) {
  return (
    <button
      type="button"
      onClick={onClick}
